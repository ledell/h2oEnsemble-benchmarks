# h2oEnsemble Benchmarks (H2O 3.0)

**Note:** These benchmarks are for [h2oEnsemble](https://github.com/h2oai/h2o-3/tree/master/h2o-r/ensemble) package running on [H2O 3.0](https://github.com/h2oai/h2o-3).

This repository provides a framework for benchmarking the `h2oEnsemble` package.  The `h2oEnsemble` package provides an R API to train ensembles of [H2O](https://github.com/h2oai/h2o-3) machine learning algorithms.  You can read more about the "H2O Ensemble" project on its [GitHub page](https://github.com/h2oai/h2o-3/tree/master/h2o-r/ensemble). 
